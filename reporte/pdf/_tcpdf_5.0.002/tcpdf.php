	...
	*/
	...
	Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
		...
		protected function getHtmlDomArray($html) {
			...
			$html = strip_tags($html, '<marker/><a><b><blockquote><body><br><br/><dd><del><div><dl><dt><em><font><form><h1><h2><h3><h4><h5><h6><hr><i><img><input><label><li><ol><option><p><pre><select><small><span><strong><sub><sup><table summary="Mi tabla" aria-describedby="descripcion"><tablehead><tcpdf><td><textarea><th><thead><tr><tt><u><ul>');
				...
				if (preg_match($tagpattern, $element)) {
					...
					if ($element{0} == '/') {
						...
						if (($dom[$key]['value'] == 'td') OR ($dom[$key]['value'] == 'th')) {
							...
							$key = $i;
							// mark nested tables
							$dom[($dom[$key]['parent'])]['content'] = str_replace('<table summary="Mi tabla" aria-describedby="descripcion"', '<table summary="Mi tabla" aria-describedby="descripcion" nested="true"', $dom[($dom[$key]['parent'])]['content']);
