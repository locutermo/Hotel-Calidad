  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        ...
        <ul class="controls">
          <li class="remove">
            <a  data-toggle="modal" data-target="#myModal"  ><em class="fa fa-hotel"></em> REGISTRAR NUEVA HABITACIÓN</a>
          </li>
          <li class="dropdown">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          if(count($tarifas_hab)>0){ ?>
                            <a href="index.php?view=ha_tarifas&id=<?php echo $habitacion->id; ?>" class="btn btn-success btn-xs"><em class="glyphicon glyphicon-eye-open"></em> Ver tarifas</a>

                          <?php }else{ ?>
                            <a href="index.php?view=ha_tarifas&id=<?php echo $habitacion->id; ?>" class="btn btn-primary btn-xs"><em class="glyphicon glyphicon-eye-open"></em> Ver tarifas</a>
                          <?php }; ?>
                          
                        </td>
                        <td>
                          <a href=""  data-toggle="modal" data-target="#myModal<?php echo $habitacion->id; ?>"  class="btn btn-warning btn-xs"><em class="glyphicon glyphicon-edit"></em> Editar</a>
                        </td>
                        <td> <a href="index.php?view=delhabitacion&id=<?php echo $habitacion->id; ?>"  class="btn btn-danger btn-xs"><em class="glyphicon glyphicon-trash"></em> Eliminar</a></td>
                        ...
                        <!--
                        <td>
                          <a href="index.php?view=delhabitacion<?php echo $habitacion->id; ?>"    class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Eliminar</a>
                        </td> 
                      -->
                      </tr> 
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Nombre &nbsp;&nbsp;</span>
                      <input type="text" class="form-control col-md-8" name="nombre" required placeholder="Ingrese nombre" pattern=".{8,50}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Detalles &nbsp;&nbsp;</span>
                      <input type="text" class="form-control" name="descripcion" required placeholder="Ingrese detalles" pattern=".{10,255}">
                    </div>
                  </div>
