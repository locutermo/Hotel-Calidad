  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        ...
        <ul class="controls">
          <li class="remove">
            <a  data-toggle="modal" data-target="#myModal"  ><em class="fa fa-user-plus"></em> NUEVO CONTACTO</a>
          </li> 
          <li class="dropdown">
              ...
              <tbody>
                <?php foreach($contactos as $cliente):?> 
                      <tr>
                        ...
                        <td>
                        <a href="index.php?view=delcontacto&id=<?php echo $cliente->id;?>"  class="btn btn-danger btn-xs"><em class="glyphicon glyphicon-trash"></em> Eliminar</a>
                        </td>
                      </tr> 
