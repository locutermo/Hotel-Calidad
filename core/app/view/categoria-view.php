  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">  
        ...
        <ul class="controls">
          <li class="remove">
            <a  data-toggle="modal" data-target="#myModal"  ><em class="fa fa-user-plus"></em> REGISTRAR NUEVA CATEGORÍA</a>
          </li>
          <li class="dropdown">
                  ...
                  <thead style="color: white; background-color: #827e7e;">
                   ...
                   <?php foreach($categorias as $categoria):?>
                      <tr>
                        ...
                        <td>
                        <a href=""  data-toggle="modal" data-target="#myModal<?php echo $categoria->id; ?>"  class="btn btn-warning btn-xs"><em class="glyphicon glyphicon-edit"></em> Editar</a>
                        </td>
                      </tr>  
