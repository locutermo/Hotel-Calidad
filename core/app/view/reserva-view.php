            ...
            <div class="col-md-offset-1 col-md-10">
              ...
              <div class="form-group"> 
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="nombre" id="nombre" required placeholder="Nombres completos" pattern=".{8,50}">
                </div>
              </div>
              ...
              <div class="form-group"> 
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="direccion" id="direccion" required placeholder="Dirección" pattern=".{10,255}">
                </div>
              </div>
