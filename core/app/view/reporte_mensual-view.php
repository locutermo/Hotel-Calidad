          ...
          <div class="box box-success box-solid">
            ...
            <form method="post"  action="reporte/pdf/documentos/reporte_mensual_user.php" id="addcaja" target="_blank">
                ...
                <div class="row">
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon text-green"><span class="fa fa-calendar"></span> AÑO</span>
              ...
              <div class="col-md-3">
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon text-green" ><span class="fa fa-calendar"></span> MES</span>
              ...
              <div class="col-md-4">
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon text-green" ><span class="fa fa-user"></span> USUARIO</span>
              ...
              <div class="col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <button  type="submit" class="btn btn-success pull-right" target="_blank"><em class='fa fa-file-pdf-o'></em> Generar PDF</button> 
                    </div>
                  </div> 
              </div>
