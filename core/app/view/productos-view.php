...
<section class="content-header">
    <ol class="breadcrumb">
      <li><a href="index.php?view=cliebte"><span class="fa fa-home"></span> Inicio</a></li>
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Código&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
                      <input type="text" class="form-control col-md-8" name="codigo" required placeholder="Ingrese Código" pattern=".{1,10}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Nombre&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control" name="nombre" required placeholder="Ingrese Nombre" pattern=".{5,50}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Marca&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control" name="marca" placeholder="Ingrese Marca (OPCIONAL)" pattern=".{2,20}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Presentación&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control" name="presentacion"  placeholder="Ingrese presentacion (OPCIONAL)" pattern=".{3,50}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Detalles  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control" name="descripcion" placeholder="Ingrese detalles (OPCIONAL)" pattern=".{8,50}">
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Precio Compra</span>
                      <input type="number" class="form-control" step="any" name="precio_compra" placeholder="Ingrese Precio (OPCIONAL)" pattern=".{1,6}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Precio Venta&nbsp;&nbsp;&nbsp;&nbsp; </span>
                      <input type="number" style="border-color: red;" class="form-control" step="any" name="precio_venta" required placeholder="Ingrese Precio" pattern=".{1,6}">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Stock inicial &nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="number" class="form-control" name="stock" required placeholder="Ingrese Stock" pattern=".{1,6}">
                    </div>
                  </div>
